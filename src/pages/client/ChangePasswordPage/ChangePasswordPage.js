...
function ChangePasswordPage() {
  ...
  const securityIcons = [
    ...
    <KeyOutlined className="floating-icon" style={{ left: '25%', top: '60%', animationDuration: '12s', animationDelay: '2s' }} />,
    <SafetyCertificateOutlined className="floating-icon" style={{ left: '45%', top: '25%', animationDuration: '20s', animationDelay: '1s' }} />,
    <SecurityScanOutlined className="floating-icon" style={{ left: '65%', top: '70%', animationDuration: '18s', animationDelay: '3s' }} />,
    <CrownTwoTone className="floating-icon" style={{ left: '80%', top: '30%', animationDuration: '14s', animationDelay: '1.5s' }} />,
    <EyeInvisibleOutlined className="floating-icon" style={{ left: '20%', top: '40%', animationDuration: '16s', animationDelay: '2.5s' }} />,
    <LockOutlined className="floating-icon" style={{ left: '70%', top: '15%', animationDuration: '13s', animationDelay: '0.5s' }} />,
    <KeyOutlined className="floating-icon" style={{ left: '85%', top: '50%', animationDuration: '17s', animationDelay: '3.5s' }} />,
  ];
        ...
        <div className="change-password-container">
          ...
          <Row gutter={[16, 16]} className="password-section">
            ...
            <Col xs={24} lg={14}>
              <Card 
                bordered={false} 
                className="change-password-card animate__animated animate__fadeInRight"
              >
                <ChangePassword />
              </Card>
            </Col>
